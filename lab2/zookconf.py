...
class Container():
    ...
    def configure_base(self):
        ...
        ## CUSTOM EDIT: https://askubuntu.com/questions/91815/how-to-install-software-or-upgrade-from-an-old-unsupported-release/91821#91821
        self.run_cmd(["sed", "-i", "-re", "s/([a-z]{2}\.)?archive.ubuntu.com|security.ubuntu.com/old-releases.ubuntu.com/", "/etc/apt/sources.list"])
