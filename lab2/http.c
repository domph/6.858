...
const char *http_request_line(int fd, char *reqpath, char *env, size_t *env_len, size_t reqpath_len)
{
    ...
    // NOTES: 
    // buf will point to the request method
    // sp1 will point to the request-uri
    //      sp1 will NOT include any parameters
    //      these will be captured in qp + 1
    // sp2 will point to the protocol (e.g. HTTP/[VER])
